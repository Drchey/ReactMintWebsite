...
import { gallery_1, gallery_2 } from '../assets'
  ...
  return (
    <div className="w-full md:px-1 px-1">
      <section className="my-1">
        <div>
          ...
          <p className={`${styles.paragraph} text-justify`}>
            The West African Currency Board held the responsibility of issuing
            currency notes in Nigeria from 1912 to 1959. Prior to its
            establishment, Nigeria utilized various forms of money, including
            cowries and manilas. On July 1st, 1959, a significant transition
            occurred as the Central Bank of Nigeria introduced the Nigerian
            currency notes and coins, leading to the withdrawal of the West
            African Currency Board notes and coins. The year 1962 marked the
            official withdrawal of legal tender status from the West African
            Currency Board.
          </p>
          <p className={`${styles.paragraph} text-justify mt-3`}>
            As Nigeria attained Republic status in 1963, the nation's banknotes
            underwent transformation to reflect its newfound identity.
            Subsequent changes in 1965 were prompted by the historical shift to
            a republic. In the year 1968, alterations were implemented in
            response to the unfortunate misuse of currency notes during the
            civil war.
          </p>
          <p className={`${styles.paragraph} text-justify mt-3`}>
            The monumental year of 1973 witnessed Nigeria's adoption of a truly
            national currency system, departing from the pounds and shillings of
            the imperial system inherited from British colonial administration.
            This shift ushered in the Naira (N) and kobo (k) denominations, with
            banknotes released in four denominations: 50 kobo, N1, N5, and N10.
          </p>
        </div>
            ...
            <div className={`${layout.serviceSection} `}>
              <div className={`w-1/2`}>
                <div className={`slide-left-container group`}>
                  <img
                    src={gallery_1}
                    alt=""
                    className="w-full object-fit h-[80%] border-[8px]"
                  />
                </div>
              </div>
              <div className={`${layout.serviceSectionInfo} px-4`}>
                <p className={`${styles.paragraph} text-justify mt-3`}>
                  ...
                  Nigerian political leader Herbert Macaulay and his years of
                  life (1864-1946).
                </p>
                <p className={`${styles.paragraph} text-justify`}>
      ...
      <div className={`w-full my-10`}>
        <p className={`${styles.paragraph} text-justify`}>
          Remarkable milestones continued with the issuance of the N20 banknote
          in 1977, featuring the portrait of the late Head of State, General
          Murtala Ramat Muhammed. His leadership qualities and contributions to
          Nigeria's evolution were commemorated through this currency.
        </p>
        <p className={`${styles.paragraph} text-justify`}>
          The N500 banknote, introduced in April 2001, symbolized another stride
          in Nigeria's financial landscape. Similarly, the N1000 banknote,
          launched in October 2005, displayed the faces of prominent figures in
          Nigeria's financial history. These advancements demonstrated the
          nation's commitment to economic growth and security.
        </p>

        <p className={`${styles.paragraph} text-justify`}>
          In 2007, economic reforms prompted a redesign of several banknotes and
          coins, unveiling new designs while preserving the heritage of
          Nigeria's currency journey.
        </p>
      </div>
    </div>
  )
