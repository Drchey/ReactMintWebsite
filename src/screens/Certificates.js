      ...
      <div className={`${styles.paddingX} ${styles.flexCenter}`}>
        <div className={`${styles.boxWidth}`}>
          <ProductHeader
            ...
            content1={`We specialize in range of printing techniques and features used to enhance the security of documents, currency, labels, and other printed materials to deter counterfeiting and fraud. These security prints are typically integrated into the design and production process and are often not visible to the naked eye.`}
          />
        </div>
      </div>
