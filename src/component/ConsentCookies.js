  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="bg-white p-6 rounded-md shadow-md">
        ...
        <p className="mb-4">
          We use cookies to give you a better and more inclusive experience. We
          only use your information in accordance with <br></br> NDPR and other
          applicable regulations as explained in our
