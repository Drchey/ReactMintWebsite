  ...
  <div className={`${layout.section} flex flex-row mb-5`}>
    ...
    <div className={layout.sectionInfo}>
      ...
      <p className={styles.paragraph}>
        ...
        nobis perspiciatis sit suscipit voluptatem distinctio, iusto odit totam
        ullam quasi, mollitia cumque, eum consequuntur excepturi. Voluptas
        maiores quam iste?
      </p>
